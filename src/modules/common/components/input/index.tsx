      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative z-0 w-full txt-compact-medium">
          <input
            ...
            placeholder=" "
            className={clsx(
              "peer pt-4 pb-1 block w-full h-11 px-4 mt-0 bg-ui-bg-field border appearance-none focus:outline-none focus:ring-0 focus:shadow-borders-interactive-with-active border-ui-border-base hover:bg-ui-bg-field-hover",
              {
          ...
          <label
            ...
            className={clsx(
              "flex items-center justify-center mx-3 px-1 transition-all absolute duration-300 peer-focus:-top-0 -z-1 origin-0 text-gray-500",
              {
